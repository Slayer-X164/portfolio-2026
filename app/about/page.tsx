  ...
  return (
    <main className="w-full min-h-screen flex justify-center bg-[#FFFFFF] dark:bg-[#121212]">
      ...
      <div className="w-full max-w-[701px] flex flex-col border-[1px] border-dashed border-[#ABABAB] dark:border-[#444444] relative overflow-hidden bg-[#FFFFFF] dark:bg-[#121212]">
        ...
        {/* Row 1 */}
        <section className="min-h-[250px] w-full flex flex-row border-b-[1px] border-dashed border-[#ABABAB] dark:border-[#444444]">
          {/* Left: AB */}
          <div className="w-1/2 flex items-start justify-start min-h-auto border-r-[1px] md:border-b-0 md:border-r-[1px] border-dashed border-[#ABABAB] dark:border-[#444444] p-6">
        ...
        {/* Row 2 */}
        <section className="min-h-[250px] w-full flex flex-row-reverse md:flex-row border-b-[1px] border-dashed border-[#ABABAB] dark:border-[#444444]">
          {/* Left: Text (Appears first on mobile) */}
          <div className="w-1/2 flex items-center justify-center min-h-auto border-r-[1px] border-dashed border-[#ABABAB] dark:border-[#444444] p-6 md:p-10 order-2 md:order-1">
            <p className="font-sans font-normal text-[12px] md:text-lg text-[#000000] dark:text-[#E0E0E0] leading-snug">
              For me Every project is a conversation between curiosity and discipline.
            </p>
          </div>
          {/* Right: OU */}
          <div className="w-1/2 flex items-end justify-end min-h-auto p-6 order-1 md:order-2  border-dashed border-[#ABABAB] dark:border-[#444444]">
        ...
        <section className="min-h-[250px] w-full flex flex-row border-b-[1px] border-dashed border-[#ABABAB] dark:border-[#444444]">
          {/* Left: T */}
          <div className="w-1/2 flex items-start justify-start min-h-auto border-r-[1px] border-dashed border-[#ABABAB] dark:border-[#444444] p-6">
