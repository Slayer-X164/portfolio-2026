...
export default function Home() {
  return (
    <main className="w-full flex justify-center  bg-[#FFFFFF] dark:bg-[#121212]">
      {/* Main Container */}
      <div className="w-full max-w-[701px] flex flex-col border-[1px] border-dashed border-[#ABABAB] dark:border-[#444444] relative overflow-hidden bg-[#FFFFFF] dark:bg-[#121212]">
        {/* top space */}
        <div className="h-[60px] w-full border-b-[1px] border-dashed border-[#ABABAB] dark:border-[#444444] relative">
          <PixelPets />
        </div>
        {/* Hero Section */}
        <section className="h-auto  w-full border-b-[1px] border-dashed border-[#ABABAB] dark:border-[#444444] relative flex items-center">
          <div className="w-full max-w-[635px] flex flex-col-reverse md:flex-row justify-between items-start md:items-center md:items-end mx-auto px-4 md:px-0 mt-[42px] mb-[52px] gap-8 md:gap-0">
            ...
            <div className="w-full text-left md:text-center md:w-[409px] h-auto md:h-[206px] flex flex-col justify-between gap-6 md:gap-0 items-start md:items-start text-center md:text-left">
              <div className="flex flex-col gap-[6px]">
                <h1 className="font-serif text-[40px] md:text-[50px] leading-none text-[#000000] dark:text-[#FFFFFF]">Hey, i’m Sidd.              </h1>
              ...
              <p className="font-charon font-light text-[14px] md:text-[13px] text-[#000000] dark:text-[#E0E0E0] leading-snug">
        ...
        {/* Experience Section */}
        <section className="h-auto w-full border-b-[1px] border-dashed border-[#ABABAB] dark:border-[#444444] flex flex-col py-[30px] px-4 md:px-[30px]">
            ...
            <div className="w-full md:w-[564px] flex flex-col gap-[10px] items-center sm:items-start text-center sm:text-left">
              <div className="flex flex-col gap-[6px] w-full items-start text-center sm:text-left">
                <div className="flex flex-row justify-between items-start w-full gap-2 sm:gap-0">
                  <h3 className="font-sans font-bold text-[13px] text-[#000000] dark:text-neutral-100">Oceanlab Technology</h3>
                  <span className="font-sans italic text-[11px] text-[#737373]">Oct 2025 - Nov 2025</span>
                </div>
                <div className="px-4 py-1 bg-[#006BFF] dark:bg-blue-800 rounded-[7.22px] border-[0.83px] border-dashed border-[#FFFFFF] dark:border-neutral-500  flex items-center justify-center">
                  <span className="font-sans font-semibold text-[12px] text-[#FFFFFF]">Frontend <span className="italic">intern</span></span>
                </div>
              </div>
              <p className="font-inria text-[14px] text-left text-[#585858] dark:text-[#A0A0A0] leading-relaxed whitespace-pre-wrap">
                <span className="font-bold text-[#585858] dark:text-[#A0A0A0]">• </span>Designed and developed responsive user interfaces from <span className="font-bold text-[#060606] dark:text-neutral-300">Figma</span> designs using <span className="font-bold text-[#000000] dark:text-neutral-300">React</span> and <span className="font-bold text-[#000000] dark:text-neutral-300">Next.js</span>, delivering pixel-perfect implementations.<br />
                <span className="font-bold text-[#585858] dark:text-[#A0A0A0]">• </span>Built clean, maintainable, and high-performance frontend code to enhance user <span className="font-bold text-[#000000] dark:text-neutral-300">experience</span> and application performance.<br />
                <span className="font-bold text-[#585858] dark:text-[#A0A0A0]">• </span>Created the company&apos;s <span className="font-bold text-[#000000] dark:text-neutral-300">logo</span> and contributed to the overall <span className="font-bold text-[#000000] dark:text-neutral-300">brand identity</span> and visual design.<br />
                <span className="font-bold text-[#585858] dark:text-[#A0A0A0]">• </span>Provided design direction and collaborated with <span className="font-bold text-[#000000] dark:text-neutral-300">cross-functional teams</span> to improve product <span className="font-bold text-[#000000] dark:text-neutral-300">quality</span> and design consistency.
              </p>
            </div>
          </div>
        </section>
